...
small_model = tf.keras.models.load_model('AI Final Project/last_finest.h5')
large_model = tf.keras.models.load_model('AI Final Project/imageotsketchfinetest.h5')
